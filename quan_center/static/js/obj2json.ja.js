...
function banner_render(msg_type, id, content, no_prefix) {
	...
	if (no_prefix) {
		...
		switch (msg_type) {
			case 'error': 
			case 'warning': 
				zh_type = 'しまった'; msg_type = 'warning'; break; 
			case 'success': 
				zh_type = 'おめでとう'; msg_type = 'success'; break; 
			case 'info': 
			case 'primary': 
				zh_type = 'ヒント'; msg_type = 'info'; break; 
			default: zh_type = '';
		}
	}
